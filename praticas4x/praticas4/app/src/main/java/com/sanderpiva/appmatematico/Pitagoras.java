    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalcula.setOnClickListener(view -> {
            ...
            if(ca1.isEmpty() || ca2.isEmpty()||ca1.equals("0")||ca2.equals("0")){
                ...
                resultadoHipotenusa.setText(String.format("%ship² = %s² + %s² -> %.2f + %.2f -> hip² = %s -> hip = √%s -> hip = %.2f",
                      resHip, ca1, ca2, pi.resultadoCa1(), pi.resultadoCa2(),pi.resultadoHipAoQuadrado(), pi.resultadoHipAoQuadrado(), pi.resultadoHip()));
